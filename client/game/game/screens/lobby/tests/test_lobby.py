...
from engine.visual_regression.visual_regression import VisualRegression
...
class TestLobby(TestCase):
    ...
    @mock.patch("game.commands.NewGame")
    ...
    @mock.patch("game.commands.GoToJoinAGame")
    ...
    @mock.patch("game.commands.GoToGameList")
    ...
    @mock.patch("game.commands.GoToOptions")
    ...
    @mock.patch("game.commands.GoToSetName")
    ...
    @mock.patch("game.commands.GoToCredits")
    ...
    @mock.patch("engine.commands.PingTheServer")
    ...
    @mock.patch("engine.commands.QuitGame")
    ...
    def test_visual_regression(self):
        VisualRegression.assert_matches_snapshot(
            self.lobby, "./game/screens/lobby/tests/screenshots/lobby.png"
        )
