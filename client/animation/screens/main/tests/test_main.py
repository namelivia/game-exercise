...
from client.animation.screens.main.main import MainScreen
...
class TestMainScreen(TestCase):
    ...
    def test_visual_regression(self, m_get_mouse_position):
        ...
        VisualRegression.assert_matches_snapshot(
            self.main,
            "./client/animation/screens/main/tests/screenshots/main_timestamp_0.png",
        )
        ...
        VisualRegression.assert_matches_snapshot(
            self.main,
            "./client/animation/screens/main/tests/screenshots/main_timestamp_5500.png",
        )
